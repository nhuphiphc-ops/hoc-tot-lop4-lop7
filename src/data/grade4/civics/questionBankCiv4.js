// Dữ liệu môn Đạo Đức Lớp 4
export const STAGES_CIV4 = [
  {
    "id": 1,
...
export const WEEKS_METADATA_CIV4 = {
  "1": {
...
export const TOPIC_CATEGORIES_CIV4 = [
...
export const getQuestionsByWeekCiv4 = (weekNum) => {
  const num = parseInt(weekNum, 10);
  return QUESTION_BANK_CIV4.filter(q => q.week === num);
};

export const getFilteredQuestionsCiv4 = ({ semester, stage, category, difficulty, count = 10 }) => {
  let list = [...QUESTION_BANK_CIV4];
